...
EVT_BEGIN(brobot_appear)
    ...
    IF_EQUAL(LW(10), 0)
        ...
        USER_FUNC(800f2f68, PTR(80c5c304))
    ...
    END_IF()
    USER_FUNC(800fe21c, PTR("ルイージ"), LW(0), LW(1), LW(2))
    USER_FUNC(800fe21c, LW(10), 0, -100, 0)
    ...
    END_INLINE()
    WAIT_MSEC(1000)
    USER_FUNC(800d2af4, PTR(80ccb1fc), PTR("ルイージ"))
    USER_FUNC(800d2af4, PTR(80ccb214), PTR("ルイージ"))
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR("ルイージ"), 31, 1)
    USER_FUNC(80103410, PTR("ルイージ"), 1)
    WAIT_MSEC(2000)
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR("ルイージ"), 32, 1)
    USER_FUNC(80103410, PTR("ルイージ"), 1)
    USER_FUNC(spm::evt_npc::evt_npc_set_property, PTR("ルイージ"), 14, PTR(80d9e780))
    ...
    ADD(LW(0), LW(3))
    DIV(LW(0), 2)
    USER_FUNC(800dff20, 1, LW(0), 55, 334, LW(0), 55, -16, 500, 11)
    WAIT_MSEC(500)
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb228), 0, PTR("ルイージ"))
    WAIT_MSEC(300)
    USER_FUNC(spm::evt_npc::evt_npc_get_position, PTR("ルイージ"), LW(0), LW(1), LW(2))
    USER_FUNC(800dff20, 1, LW(0), 55, 334, LW(0), 55, -16, 500, 11)
    USER_FUNC(800d2af4, PTR(80ccb108), PTR("ルイージ"))
    ...
    USER_FUNC(800d2148, 1, PTR(80ccb258))
    INLINE_EVT_ID(LW(11))
    ...
    USER_FUNC(800d2b64, PTR(80ccb0b8), PTR("ルイージ"), 2000)
    USER_FUNC(800dff20, 1, 0, 100, 644, 0, 100, -16, 3000, 11)
    ...
    DO(0)
        ...
        USER_FUNC(800fe21c, LW(2), 0, LW(0), 0)
        WAIT_FRM(1)
        IF_EQUAL(LW(1), 0)
            DO_BREAK()
        END_IF()
    ...
    USER_FUNC(800dff20, 1, -10, 165, 434, -10, 165, -16, 500, 11)
    USER_FUNC(800d29cc, PTR(80ccb2e8), 0, 0, 0)
    USER_FUNC(spm::evt_npc::evt_npc_set_property, PTR("ルイージ"), 14, PTR(80d9e780))
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR("ルイージ"), 25, 1)
    USER_FUNC(801004c0, PTR("ルイージ"), 0, 150, 0, FLOAT(100.0), 500)
    USER_FUNC(800d29cc, PTR(80ccb2fc), 0, 0, 0)
    USER_FUNC(800fe21c, PTR("ルイージ"), 0, -1000, 0)
    USER_FUNC(80102f5c, PTR(80ccb310), PTR(80ccb318), 0)
    USER_FUNC(800fe21c, PTR(80ccb310), 0, -1000, 0)
    ...
    USER_FUNC(800fe21c, PTR(80ccb310), LW(0), LW(1), LW(2))
    SET(LW(3), LW(1))
    ADD(LW(3), -100)
    MUL(LW(1), 100)
    MUL(LW(3), 100)
    ...
    DO(0)
        USER_FUNC(800d3878)
        DIVF(LW(0), FLOAT(100.0))
        USER_FUNC(800fe21c, PTR(80ccb310), LW(7), LW(0), LW(9))
        WAIT_FRM(1)
        IF_EQUAL(LW(1), 0)
            DO_BREAK()
        END_IF()
    ...
    USER_FUNC(80103410, PTR(80ccb310), 1)
...
EVT_BEGIN(mr_l_appear)
    ...
    END_INLINE()
    USER_FUNC(800d2cd8, PTR(80ccaff8), PTR(80ccb010), PTR(80ccb028), 0)
    USER_FUNC(spm::evt_mario::evt_mario_set_pose, PTR(80ccb040), 0)
    USER_FUNC(800d2af4, PTR(80ccb044), PTR("ルイージ"))
    USER_FUNC(spm::evt_npc::evt_npc_set_property, PTR(80ccaf54), 14, PTR(80d9e778))
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR(80ccaf54), 0, 1)
    ADD(LW(0), 100)
    USER_FUNC(800d2af4, PTR(80ccafd8), PTR("ルイージ"))
    USER_FUNC(801004c0, PTR("ルイージ"), LW(0), 0, LW(2), FLOAT(80.0), 500)
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR("ルイージ"), 0, 1)
    USER_FUNC(800d2af4, PTR(80ccb05c), PTR("ルイージ"))
    USER_FUNC(spm::evt_npc::evt_npc_get_position, PTR("ルイージ"), LW(3), LW(4), LW(5))
    USER_FUNC(800d29cc, PTR(80ccb05c), LW(3), LW(4), LW(5))
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb070), 0, PTR(80ccaf54))
    WAIT_MSEC(300)
    USER_FUNC(spm::evt_mario::evt_mario_get_character, LW(0))
    SWITCH(LW(0))
        CASE_EQUAL(0)
        CASE_EQUAL(1)
            USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb07c), 0, PTR(80ccb088))
            WAIT_MSEC(300)
        CASE_EQUAL(2)
            USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb094), 0, PTR(80ccb088))
            WAIT_MSEC(300)
    END_SWITCH()
    USER_FUNC(800d2148, 1, PTR(80ccb0a0))
    USER_FUNC(800dff20, 1, 100, 38, 234, 100, 38, -16, 500, 11)
    WAIT_MSEC(500)
    USER_FUNC(800d2b64, PTR(80ccb0b8), PTR("ルイージ"), 750)
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb0d0), 0, PTR("ルイージ"))
    WAIT_MSEC(300)
    USER_FUNC(spm::evt_mario::evt_mario_set_pose, PTR(80ccb0dc), 0)
    USER_FUNC(800f19c0)
    USER_FUNC(spm::evt_mario::evt_mario_set_pose, PTR(80ccb0e0), 0)
    USER_FUNC(800dff20, 1, 0, 85, 584, 0, 85, -16, 0, 11)
    WAIT_MSEC(300)
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb0e4), 0, PTR(80ccb0f0))
    WAIT_MSEC(300)
    USER_FUNC(spm::evt_npc::evt_npc_set_property, PTR("ルイージ"), 14, PTR(80d9e780))
    USER_FUNC(spm::evt_npc::func_801059d0, PTR("ルイージ"), -1)
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR("ルイージ"), 0, 1)
    USER_FUNC(800dff20, 1, 100, 85, 584, 100, 85, -16, 500, 11)
    WAIT_MSEC(500)
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb0fc), 0, PTR("ルイージ"))
    WAIT_MSEC(300)
    USER_FUNC(800d2af4, PTR(80ccb108), PTR("ルイージ"))
    USER_FUNC(800d2af4, PTR(80ccb120), PTR("ルイージ"))
    USER_FUNC(800e658c, 0, 0)
    DO(3)
        USER_FUNC(800dff20, 1, 100, 85, 584, 100, 85, -16, 0, 0)
        WAIT_FRM(1)
        USER_FUNC(800dff20, 1, 100, 37, 234, 100, 37, -16, 250, 0)
        WAIT_MSEC(250)
    WHILE()
    USER_FUNC(800e6624)
    WAIT_MSEC(300)
    INLINE_EVT()
        ...
        USER_FUNC(80c5c36c)
    END_INLINE()
    USER_FUNC(spm::evt_npc::evt_npc_set_property, PTR("ルイージ"), 14, PTR(80d9e908))
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR("ルイージ"), 35, 1)
    USER_FUNC(80103410, PTR("ルイージ"), 1)
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb138), 0, PTR("ルイージ"))
    WAIT_MSEC(300)
    USER_FUNC(800e6148, PTR(80ccb148))
    USER_FUNC(800dff20, 1, -35, 60, 384, -35, 60, -16, 0, 11)
    WAIT_MSEC(500)
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb14c), 0, PTR(80ccb0f0))
    WAIT_MSEC(300)
    USER_FUNC(800f2f68, PTR(80c5c150))
    USER_FUNC(spm::evt_mario::evt_mario_get_character, LW(0))
    SWITCH(LW(0))
        CASE_EQUAL(0)
        CASE_EQUAL(1)
    ...
    USER_FUNC(spm::evt_npc::evt_npc_get_position, PTR(80ccaf54), LW(0), LW(1), LW(2))
    USER_FUNC(800ffbd8, PTR("ルイージ"), LW(0), LW(2), 0, FLOAT(120.0), 0, 2, 0)
    USER_FUNC(800e57bc, 0, PTR(80ccaff0), 0, LW(0), LW(1), LW(2), 0, 0, 0, 0, 0, 0, 0, 0)
    USER_FUNC(800d29cc, PTR(80ccb178), LW(0), LW(1), LW(2))
    USER_FUNC(800d29cc, PTR(80ccb190), LW(0), LW(1), LW(2))
    ADD(LW(1), -100)
    ADD(LW(2), 100)
    USER_FUNC(80107bcc, PTR(80ccaf54), 9)
    INLINE_EVT_ID(LW(10))
        SET(LW(0), 0)
        DO(0)
            ADD(LW(0), 20)
            MOD(LW(0), 360)
            USER_FUNC(800fe92c, PTR(80ccaf54), 0, 10, 0)
            USER_FUNC(800fe668, PTR(80ccaf54), 0, 0, LW(0))
            WAIT_FRM(1)
        WHILE()
    END_INLINE()
    USER_FUNC(801004c0, PTR(80ccaf54), LW(0), LW(1), LW(2), FLOAT(100.0), 600)
    DELETE_EVT(LW(10))
    USER_FUNC(800fe21c, PTR(80ccaf54), 0, -1000, 0)
    USER_FUNC(800fe668, PTR(80ccaf54), 0, 0, 0)
    USER_FUNC(80107bcc, PTR(80ccaf54), 5)
    USER_FUNC(spm::evt_npc::func_80108194, PTR("ルイージ"), 0)
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb1a4), 0, PTR("ルイージ"))
    WAIT_MSEC(300)
    USER_FUNC(800dff20, 1, -25, 45, 184, -25, 45, -16, 500, 11)
    USER_FUNC(spm::evt_npc::evt_npc_set_property, PTR("ルイージ"), 14, PTR(80d9e868))
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, PTR("ルイージ"), 26, 1)
    USER_FUNC(80103410, PTR("ルイージ"), 1)
    USER_FUNC(spm::evt_mario::evt_mario_get_character, LW(0))
    SWITCH(LW(0))
        CASE_EQUAL(0)
            USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb1b0), 0, PTR("ルイージ"))
            WAIT_MSEC(300)
        CASE_EQUAL(1)
            USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb1bc), 0, PTR("ルイージ"))
            WAIT_MSEC(300)
        CASE_EQUAL(2)
            USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR(80ccb1c8), 0, PTR("ルイージ"))
            WAIT_MSEC(300)
    END_SWITCH()
    USER_FUNC(800e0430, 500, 11)
    WAIT_MSEC(500)
    WAIT_MSEC(500)
    USER_FUNC(spm::evt_npc::evt_npc_get_position, PTR("ルイージ"), LW(0), LW(1), LW(2))
    USER_FUNC(spm::evt_npc::evt_npc_entry_from_template, 123, 137, LW(0), LW(1), LW(2), LW(3), EVT_NULLPTR)
    USER_FUNC(80103ea8, LW(3), 8, PTR(80d9f620))
    USER_FUNC(800fe21c, PTR("ルイージ"), 0, -1000, 0)
    SET(GSW(0), 170)
    INLINE_EVT()
        USER_FUNC(spm::evt_snd::evt_snd_bgmoff_f_d, 1, 1000)
        WAIT_MSEC(1000)
        USER_FUNC(800d2148, 0, PTR(80ccb1d4))
    END_INLINE()
    USER_FUNC(800f2f68, PTR(80c5c304))
    USER_FUNC(spm::evt_mario::evt_mario_get_character, LW(0))
    IF_EQUAL(LW(0), 1)
