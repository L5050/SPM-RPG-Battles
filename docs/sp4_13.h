...
EVT_BEGIN(brobot_appear)
    ...
    USER_FUNC(evt_img_set_paper, PTR("img"), PTR("OFF_d_yabu_small"))
    USER_FUNC(evt_img_set_paper_anim, PTR("img"), PTR("Z_1"))
    USER_FUNC(evt_img_alloc_capture, PTR("img"), 0, 0, 0, 0, 0, 608, 480)
    ...
    USER_FUNC(evt_mario_face_npc, PTR("ルイージ"))
    USER_FUNC(evt_img_free_capture, PTR("img"), 0)
    USER_FUNC(evt_img_release, PTR("img"))
    USER_FUNC(evt_paper_delete, PTR("OFF_d_yabu_small"))
    WAIT_MSEC(300)
    DELETE_EVT(LW(11))
...
EVT_BEGIN(mr_l_appear)
    ...
    WAIT_MSEC(300)
    USER_FUNC(spm::evt_mario::evt_mario_set_anim_change_handler, PTR(&spm::sp4_13::spReturnAngryAnimPos))
    USER_FUNC(spm::evt_mario::evt_mario_get_character, LW(0))
    SWITCH(LW(0))
        CASE_EQUAL(0)
        CASE_EQUAL(1)
