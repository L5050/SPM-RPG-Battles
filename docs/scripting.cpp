...
namespace docs {
  ...
  EVT_BEGIN(techChild1)
      ...
      DO(3)
          USER_FUNC(spm::evt_rpg::evt_rpg_status_remove, 1, LW(10), 32)
          WAIT_FRM(3)
          USER_FUNC(spm::evt_rpg::evt_rpg_status_remove, 0, LW(10), 32)
          WAIT_FRM(3)
      WHILE()
      RETURN()
  EVT_END()
  ...
  EVT_BEGIN(techChild2)
      DO(4)
          USER_FUNC(spm::evt_rpg::evt_rpg_status_remove, 1, LW(10), 16)
          WAIT_FRM(4)
          USER_FUNC(spm::evt_rpg::evt_rpg_status_remove, 0, LW(10), 16)
          WAIT_FRM(4)
      WHILE()
      RETURN()
  EVT_END()
  ...
  EVT_BEGIN(checkMarioDeath)
      ...
      ELSE()
          USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(0))
          ...
          USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 32768)
      END_IF()
      RETURN()
  EVT_END()

  EVT_BEGIN(underchompAttack1)
      USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, 0, LW(0))
      USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, 0, LW(1))
      IF_FLAG(LW(0), 0x8000)
          RETURN()
      END_IF()
      IF_FLAG(LW(0), 0x3)
      ...
      IF_FLAG(LW(0), 0x4)
          ...
          RETURN()
      END_IF()
      USER_FUNC(spm::evt_rpg::evt_rpg_effect_check, LW(2))
      USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(3))
      IF_FLAG(LW(2), 0x5)
          ...
          CASE_SMALL(1000)
              ...
              ELSE()
                  ...
                  ELSE()
                      ...
                      USER_FUNC(spm::evt_rpg::evt_rpg_calc_mario_damage, 0, LW(10))
                      USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_094"), LW(3), LW(10))
                      USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(10), 0, LW(0))
                  END_IF()
              END_IF()
          CASE_SMALL(2000)
...
EVT_END()
  ...
  EVT_BEGIN(attack)
      USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(10))
      ...
      ELSE()
          ...
          USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(2), 0, LW(10))
          ...
          END_SWITCH()
          USER_FUNC(spm::evt_rpg::evt_rpg_enemy_take_damage, LW(2), LW(10), 0, LW(0))
          IF_FLAG(LW(0), 0x8000)
          ...
          ELSE()
              IF_FLAG(LW(0), 0x1)
                  USER_FUNC(spm::evt_rpg::evt_rpg_status_remove, 0, LW(2), 1)
...
SWITCH(LW(10))
    ...
    CASE_EQUAL(3)
        ...
        ELSE()
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_enemy_take_damage, LW(4), LW(10), 0, LW(0))
            IF_FLAG(LW(0), 0x8000)
                USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_E_ENEMY_DIE1"))
                USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_007"), LW(3))
            ELSE()
                IF_FLAG(LW(0), 0x1)
                    USER_FUNC(spm::evt_rpg::evt_rpg_status_remove, 0, LW(4), 1)
    ...
    SWITCH(LW(2))
        ...
        CASE_EQUAL(222)
            ...
            ELSE()
                ...
                SET(LW(10), LW(4))
                RUN_CHILD_EVT(mod::techChild2)
                USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(4), 20, LW(10))
        ...
        CASE_EQUAL(223)
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 1)
        CASE_EQUAL(224)
            USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(10))
            ...
            ELSE()
                ...
                SET(LW(10), LW(4))
                RUN_CHILD_EVT(mod::techChild2)
                USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(4), 15, LW(10))
        ...
        CASE_EQUAL(225)
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 2)
        CASE_EQUAL(226)
            USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(10))
            ...
            ELSE()
                USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, LW(4), LW(10))
                IF_FLAG(LW(10), 0x3)
                    USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_042"), LW(3))
                ELSE()
                    SET(LW(10), LW(4))
                    RUN_CHILD_EVT(mod::techChild2)
                    USER_FUNC(spm::evt_rpg::evt_rpg_enemy_take_damage, LW(4), 0, 4, LW(0))
        ...
        CASE_EQUAL(227)
            ...
            ELSE()
                ...
                SET(LW(10), LW(4))
                RUN_CHILD_EVT(mod::techChild2)
                USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(4), 1, LW(10))
        ...
        CASE_EQUAL(228)
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 4)
        CASE_EQUAL(229)
            USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(10))
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_effect_check, LW(10))
            IF_FLAG(LW(10), 0x7800)
                USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(10))
                USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_065"), LW(10))
                USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 30720)
            END_IF()
            USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, 0, LW(10))
            IF_NOT_FLAG(LW(10), 0x8000)
                USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_I_NEMURE_SUCCESS1"))
                SET(LW(10), 0)
                RUN_CHILD_EVT(mod::techChild2)
                USER_FUNC(spm::evt_rpg::evt_rpg_enemy_take_damage, 0, 0, 2, LW(0))
                USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, 0, LW(10))
                USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_052"), LW(10))
            END_IF()
            USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, 1, LW(10))
            IF_NOT_FLAG(LW(10), 0x8000)
                USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_I_NEMURE_SUCCESS1"))
                SET(LW(10), 1)
                RUN_CHILD_EVT(mod::techChild2)
                USER_FUNC(spm::evt_rpg::evt_rpg_enemy_take_damage, 1, 0, 2, LW(0))
                USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, 1, LW(10))
                USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_052"), LW(10))
            END_IF()
            USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, 2, LW(10))
            IF_NOT_FLAG(LW(10), 0x8000)
                USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_I_NEMURE_SUCCESS1"))
                SET(LW(10), 2)
                RUN_CHILD_EVT(mod::techChild2)
                USER_FUNC(spm::evt_rpg::evt_rpg_enemy_take_damage, 2, 0, 2, LW(0))
                USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, 2, LW(10))
                USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_052"), LW(10))
            END_IF()
        CASE_EQUAL(230)
            ...
            ELSE()
                ...
                SET(LW(10), LW(4))
                RUN_CHILD_EVT(mod::techChild2)
                USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(4), 108, LW(10))
...
EVT_BEGIN(items)
    ...
    SWITCH(LW(2))
        CASE_EQUAL(70)
            ...
            SET(LW(10), LW(4))
            RUN_CHILD_EVT(mod::techChild2)
            USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(4), 13, LW(10))
    ...
    SWITCH(LW(2))
        ...
        CASE_OR(161)
            SET(LW(5), 0)
            DO(3)
                USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, LW(5), LW(10))
                IF_NOT_FLAG(LW(10), 0x8000)
                    USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_I_FIRE1_1"))
                    USER_FUNC(spm::evt_snd::evt_snd_sfx_wait_name, PTR("SFX_I_FIRE1_1"))
                    SET(LW(10), LW(5))
                    RUN_CHILD_EVT(mod::techChild1)
                    USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, LW(5), LW(10))
        ...
        CASE_OR(146)
            ...
            DO(3)
                ...
                IF_NOT_FLAG(LW(10), 0x8000)
                    ...
                    SWITCH(LW(2))
                        CASE_EQUAL(66)
                            USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(5), 101, LW(11))
                        CASE_EQUAL(148)
                            USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(5), 105, LW(11))
                        CASE_EQUAL(149)
                            USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(5), 106, LW(11))
                        CASE_EQUAL(147)
                            USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(5), 105, LW(11))
                        CASE_EQUAL(146)
                            USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(5), 106, LW(11))
                    ...
                    USER_FUNC(spm::evt_rpg::evt_rpg_enemy_take_damage, LW(5), LW(11), 0, LW(0))
                    IF_FLAG(LW(0), 0x8000)
                    ...
                    ELSE()
                        IF_FLAG(LW(0), 0x1)
                            USER_FUNC(spm::evt_rpg::evt_rpg_status_remove, 0, LW(5), 1)
        ...
        CASE_EQUAL(67)
            ...
            DO(3)
                ...
                IF_NOT_FLAG(LW(10), 0x8000)
                    ...
                    RUN_CHILD_EVT(mod::techChild2)
                    USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, LW(5), LW(10))
                    USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(5), 102, LW(11))
        ...
        CASE_OR(163)
            ...
            DO(3)
                ...
                IF_NOT_FLAG(LW(10), 0x8000)
                    ...
                    SWITCH(LW(2))
                        CASE_EQUAL(68)
                            USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(5), 103, LW(11))
                        CASE_EQUAL(163)
                            USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(5), 107, LW(11))
                    END_SWITCH()
        ...
        CASE_OR(214)
            ...
            DO(3)
                ...
                IF_NOT_FLAG(LW(10), 0x8000)
                    ...
                    RUN_CHILD_EVT(mod::techChild2)
                    USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, LW(5), LW(10))
                    USER_FUNC(spm::evt_rpg::evt_rpg_mario_take_damage, LW(5), 104, LW(11))
    ...
    SWITCH(LW(2))
        ...
        CASE_OR(206)
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(5))
            USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_072"), LW(5))
            USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 16)
            CASE_END()
    END_SWITCH()
    SWITCH(LW(2))
        CASE_OR(74)
        ...
        CASE_OR(104)
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 64)
            CASE_END()
    END_SWITCH()
    SWITCH(LW(2))
        CASE_OR(75)
        ...
        CASE_OR(113)
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 256)
            CASE_END()
    END_SWITCH()
    SWITCH(LW(2))
        CASE_OR(76)
        ...
        CASE_OR(215)
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 128)
            CASE_END()
    END_SWITCH()
    SWITCH(LW(2))
        CASE_OR(78)
        ...
        CASE_OR(176)
            ...
            DO(3)
                ...
                IF_NOT_FLAG(LW(10), 0x8000)
                    ...
                    USER_FUNC(spm::evt_rpg::evt_rpg_enemy_take_damage, LW(5), 0, 1, LW(10))
                END_IF()
                ADD(LW(5), 1)
            WHILE()
            CASE_END()
    ...
    SWITCH(LW(2))
        ...
        CASE_OR(124)
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 32)
            CASE_END()
    END_SWITCH()
    SWITCH(LW(2))
        CASE_EQUAL(86)
            USER_FUNC(spm::evt_rpg::evt_rpg_get_item_msg, LW(1), LW(2))
            USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(5))
            ...
            IF_EQUAL(LW(2), 70)
                USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, 0, LW(10))
                IF_NOT_FLAG(LW(10), 0x8000)
                    USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, 0, LW(3))
                    SET(LW(4), 0)
                END_IF()
                USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, 1, LW(10))
                IF_NOT_FLAG(LW(10), 0x8000)
                    USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, 1, LW(3))
                    SET(LW(4), 1)
                END_IF()
                USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, 2, LW(10))
                IF_NOT_FLAG(LW(10), 0x8000)
                    USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, 2, LW(3))
                    SET(LW(4), 2)
                END_IF()
            END_IF()
            SET(LF(0), 1)
    ...
    SWITCH(LW(2))
        CASE_ETC()
            USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(5))
            USER_FUNC(spm::evt_rpg::evt_rpg_calc_item_stats, LW(2), LW(10), LW(6), LW(7)) //hp gain goes in LW 6, xp in LW 7
            IF_LARGE(LW(6), 0)
                USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_I_KINKYU_KINOKO1"))
                USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_I_RECOVER_HP_EFFECT_SMALL1"))
                WAIT_MSEC(350)
            ...
            SWITCH(LW(2))
                CASE_EQUAL(125)
                    USER_FUNC(spm::evt_rpg::evt_rpg_effect_check, LW(8))
                    IF_FLAG(LW(8), 0x8)
                        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_064"), LW(5))
                        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 8)
                    END_IF()
                CASE_ETC()
                    IF_LARGE(LW(6), 0)
                        USER_FUNC(spm::evt_rpg::evt_rpg_effect_check, LW(8))
            ...
            IF_LARGE(LW(7), 0)
                ...
                USER_FUNC(spm::evt_rpg::evt_rpg_add_xp, LW(7))
            END_IF()
            SWITCH(LW(2))
                CASE_EQUAL(98)
                    ...
                    USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 8)
            END_SWITCH()
            SWITCH(LW(2))
                CASE_OR(201)
                CASE_OR(173)
                    USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_085_03"), LW(5), LW(5))
                    USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 16384)
                    CASE_END()
            END_SWITCH()
            SWITCH(LW(2))
                CASE_OR(173)
                CASE_OR(189)
                    ...
                    USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 4096)
                    CASE_END()
            END_SWITCH()
            SWITCH(LW(2))
                CASE_OR(173)
                CASE_OR(144)
                    ...
                    USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 2048)
                    CASE_END()
            END_SWITCH()
            SWITCH(LW(2))
                CASE_OR(173)
                CASE_OR(185)
                    ...
                    USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 1, 8192)
                    CASE_END()
            END_SWITCH()
    END_SWITCH()
    RETURN()
...
EVT_BEGIN(checkWinOrContinue)
    USER_FUNC(spm::evt_rpg::evt_rpg_wakeup_check, 0, LW(0))
    IF_NOT_EQUAL(LW(0), 0)
        USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, 0, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, LW(0), LW(1))
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_wakeup_check, 1, LW(0))
    IF_NOT_EQUAL(LW(0), 0)
        USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, 1, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, LW(0), LW(1))
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_wakeup_check, 2, LW(0))
    IF_NOT_EQUAL(LW(0), 0)
        USER_FUNC(spm::evt_rpg::evt_rpg_underchomp_name_grab, 2, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, LW(0), LW(1))
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 0, LW(0))
    IF_EQUAL(LW(0), 2)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_125"), LW(1))
        USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_F_SLIT_RETURN1"))
        USER_FUNC(spm::evt_snd::evt_snd_sfx_wait_name, PTR("SFX_F_SLIT_RETURN1"))
        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 1)
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 1, LW(0))
    IF_EQUAL(LW(0), 2)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_126"), LW(1))
        USER_FUNC(spm::evt_snd::evt_snd_sfxon_character, PTR("SFX_P_MARIO_JUMP1"), PTR("SFX_P_PEACH_JUMP1"), PTR("SFX_P_KOOPA_JUMP1"), PTR("SFX_P_LUIGI_JUMP1"))
        WAIT_MSEC(500)
        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 2)
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 2, LW(0))
    IF_EQUAL(LW(0), 2)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        ...
        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 4)
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 3, LW(0))
    IF_EQUAL(LW(0), 1)
    ...
    ELSE()
        ...
        END_IF()
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 4, LW(0))
    IF_EQUAL(LW(0), 2)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_124"), LW(1))
        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 16)
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 12, LW(0))
    IF_EQUAL(LW(0), 2)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_124_03"), LW(1))
        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 4096)
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 14, LW(0))
    IF_EQUAL(LW(0), 2)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_124_04"), LW(1))
        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 16384)
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 13, LW(0))
    IF_EQUAL(LW(0), 2)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_124_05"), LW(1))
        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 8192)
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 11, LW(0))
    IF_EQUAL(LW(0), 2)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_117"), LW(1))
        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 2048)
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 5, LW(0))
    IF_EQUAL(LW(0), 1)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_117"), LW(1))
    ...
    ELSE()
        IF_EQUAL(LW(0), 2)
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 32)
        END_IF()
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 6, LW(0))
    IF_EQUAL(LW(0), 2)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_123"), LW(1))
        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 64)
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 7, LW(0))
    IF_EQUAL(LW(0), 2)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_122"), LW(1))
        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 128)
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 8, LW(0))
    IF_EQUAL(LW(0), 2)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_121"), LW(1))
        USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 256)
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 9, LW(0))
    IF_EQUAL(LW(0), 1)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
    ...
    ELSE()
        IF_EQUAL(LW(0), 2)
            ...
            USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 512)
        END_IF()
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_effects_handle, 10, LW(0))
    IF_EQUAL(LW(0), 1)
        USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
        USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_112"), LW(1))
    ELSE()
        IF_EQUAL(LW(0), 2)
            USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(1))
            USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_115"), LW(1))
            USER_FUNC(spm::evt_rpg::evt_rpg_menu_effects_handler, 0, 1024)
        END_IF()
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, 0, LW(0))
    IF_NOT_FLAG(LW(0), 0x8000)
        RETURN()
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, 1, LW(0))
    IF_NOT_FLAG(LW(0), 0x8000)
        RETURN()
    END_IF()
    USER_FUNC(spm::evt_rpg::evt_rpg_enemy_death_check, 2, LW(0))
    IF_NOT_FLAG(LW(0), 0x8000)
        RETURN()
    END_IF()
    INLINE_EVT()
    ...
    END_INLINE()
    USER_FUNC(spm::evt_rpg::evt_rpg_char_get, LW(10))
    USER_FUNC(spm::evt_rpg::evt_rpg_point_calculation, 0, LW(11))
    USER_FUNC(spm::evt_rpg::evt_rpg_point_calculation, 1, LW(12))
    USER_FUNC(spm::evt_rpg::evt_rpg_point_calculation, 2, LW(13)) //fills the lws with points gained from the turn based combat
    USER_FUNC(spm::evt_rpg::evt_rpg_point_handling, LW(14))
    ADD(LW(11), LW(12))
    ADD(LW(11), LW(13))
...
USER_FUNC(spm::evt_fade::evt_fade_end_wait, -1)
INLINE_EVT()
    USER_FUNC(spm::evt_rpg::evt_rpg_npctribe_handle)
END_INLINE()
...
DO(0)
    ...
    IF_NOT_FLAG(LW(0), 0x600)
        USER_FUNC(spm::evt_rpg::evt_rpg_choice_handler, LW(0), LW(1), LW(2), LW(3), LW(4))
        SWITCH(LW(0))
            CASE_EQUAL(0)
...
USER_FUNC(spm::evt_rpg::changeRandomDAT1)
...
USER_FUNC(spm::evt_rpg::evt_unknown_pointer_change, 1)
...
IF_SMALL(GSW(0), 324)
    ...
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_133"), PTR(spm::evt_msg::evt_an2_08_draw_face), 0)
ELSE()
    USER_FUNC(spm::evt_map::evt_mapobj_get_position, PTR("kuti_1"), LW(0), LW(1), LW(2))
    USER_FUNC(spm::evt_msg::evt_msg_toge, 2, LW(0), LW(1), LW(2))
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_133_2_129"), PTR(spm::evt_msg::evt_an2_08_draw_face), 0)
END_IF()
USER_FUNC(spm::evt_cam::evt_cam3d_evt_zoom_in, 1, 3475, 1070, 184, 3475, 1070, -16, 500, 11)
WAIT_MSEC(500)
USER_FUNC(spm::evt_map::evt_mapobj_get_position, PTR("kuti_1"), LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_toge, 2, LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_133_1"), PTR(spm::evt_msg::evt_an2_08_draw_face), 0)
...
USER_FUNC(spm::evt_img::evt_img_entry, PTR("img"))
USER_FUNC(spm::evt_img::evt_img_set_paper, PTR("img"), PTR("OFF_d_bom"))
USER_FUNC(spm::evt_img::evt_img_alloc_capture, PTR("img"), 0, 0, 1, 0, 0, 608, 480)
USER_FUNC(spm::evt_img::evt_img_set_paper_anim, PTR("img"), PTR("Z_1"))
USER_FUNC(spm::evt_img::evt_img_free_capture, PTR("img"), 1)
...
USER_FUNC(spm::evt_img::evt_img_set_paper_anim, PTR("img"), PTR("A_1"))
USER_FUNC(spm::evt_img::evt_img_wait_animend, PTR("img"))
USER_FUNC(spm::evt_img::evt_img_release, PTR("img"))
...
USER_FUNC(spm::evt_map::evt_mapobj_get_position, PTR("kuti_1"), LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_toge, 2, LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_133_2"), PTR(spm::evt_msg::evt_an2_08_draw_face), 0)
...
USER_FUNC(spm::evt_map::evt_mapobj_get_position, PTR("kuti_1"), LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_toge, 2, LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_133_2_128"), PTR(spm::evt_msg::evt_an2_08_draw_face), 0)
...
USER_FUNC(spm::evt_map::evt_mapobj_get_position, PTR("kuti_1"), LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_toge, 2, LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_134"), PTR(spm::evt_msg::evt_an2_08_draw_face), 0)
...
USER_FUNC(spm::evt_rpg::evt_unknown_pointer_change, 0)
