...
namespace docs {
  ...
  EVT_BEGIN(underchompAttack1)
      USER_FUNC(spm::evt_mario::evt_rpg_enemy_take_damage, 0, LW(0))
...
EVT_END()
  ...
  EVT_BEGIN(attack)
      ...
      ELSE()
          ...
          USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(2), 0, LW(10))
    ...
    SWITCH(LW(2))
        ...
        CASE_EQUAL(222)
            ...
            ELSE()
                ...
                SET(LW(10), LW(4))
                RUN_CHILD_EVT(mod::techChild2)
                USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(4), 20, LW(10))
        ...
        CASE_EQUAL(224)
            ...
            ELSE()
                ...
                SET(LW(10), LW(4))
                RUN_CHILD_EVT(mod::techChild2)
                USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(4), 15, LW(10))
        ...
        CASE_EQUAL(226)
            ...
            ELSE()
                USER_FUNC(spm::evt_mario::evt_rpg_enemy_take_damage, LW(4), LW(10))
                IF_FLAG(LW(10), 0x3)
        ...
        CASE_EQUAL(227)
            ...
            ELSE()
                ...
                SET(LW(10), LW(4))
                RUN_CHILD_EVT(mod::techChild2)
                USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(4), 1, LW(10))
        ...
        CASE_EQUAL(229)
            ...
            END_IF()
            USER_FUNC(spm::evt_mario::evt_rpg_enemy_take_damage, 0, LW(10))
            ...
            END_IF()
            USER_FUNC(spm::evt_mario::evt_rpg_enemy_take_damage, 1, LW(10))
            IF_NOT_FLAG(LW(10), 0x8000)
                USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_I_NEMURE_SUCCESS1"))
                SET(LW(10), 1)
                RUN_CHILD_EVT(mod::techChild2)
                ...
                USER_FUNC(spm::evt_msg::evt_msg_print_add_insert, 0, PTR("stg7_2_133_2_052"), LW(10))
            END_IF()
            USER_FUNC(spm::evt_mario::evt_rpg_enemy_take_damage, 2, LW(10))
            IF_NOT_FLAG(LW(10), 0x8000)
                USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_I_NEMURE_SUCCESS1"))
                SET(LW(10), 2)
                RUN_CHILD_EVT(mod::techChild2)
        ...
        CASE_EQUAL(230)
            ...
            ELSE()
                ...
                SET(LW(10), LW(4))
                RUN_CHILD_EVT(mod::techChild2)
                USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(4), 108, LW(10))
...
EVT_BEGIN(items)
    ...
    SWITCH(LW(2))
        CASE_EQUAL(70)
            ...
            SET(LW(10), LW(4))
            RUN_CHILD_EVT(mod::techChild2)
            USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(4), 13, LW(10))
    ...
    SWITCH(LW(2))
        ...
        CASE_OR(161)
            SET(LW(5), 0)
            DO(3)
                USER_FUNC(spm::evt_mario::evt_rpg_enemy_take_damage, LW(5), LW(10))
                IF_NOT_FLAG(LW(10), 0x8000)
        ...
        CASE_OR(146)
            ...
            DO(3)
                ...
                IF_NOT_FLAG(LW(10), 0x8000)
                    ...
                    SWITCH(LW(2))
                        CASE_EQUAL(66)
                            USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(5), 101, LW(11))
                        CASE_EQUAL(148)
                            USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(5), 105, LW(11))
                        CASE_EQUAL(149)
                            USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(5), 106, LW(11))
                        CASE_EQUAL(147)
                            USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(5), 105, LW(11))
                        CASE_EQUAL(146)
                            USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(5), 106, LW(11))
        ...
        CASE_EQUAL(67)
            ...
            DO(3)
                ...
                IF_NOT_FLAG(LW(10), 0x8000)
                    ...
                    RUN_CHILD_EVT(mod::techChild2)
                    USER_FUNC(spm::evt_mario::evt_rpg_underchomp_name_grab, LW(5), LW(10))
                    USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(5), 102, LW(11))
        ...
        CASE_OR(163)
            ...
            DO(3)
                ...
                IF_NOT_FLAG(LW(10), 0x8000)
                    ...
                    SWITCH(LW(2))
                        CASE_EQUAL(68)
                            USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(5), 103, LW(11))
                        CASE_EQUAL(163)
                            USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(5), 107, LW(11))
                    END_SWITCH()
        ...
        CASE_OR(214)
            ...
            DO(3)
                ...
                IF_NOT_FLAG(LW(10), 0x8000)
                    ...
                    RUN_CHILD_EVT(mod::techChild2)
                    USER_FUNC(spm::evt_mario::evt_rpg_underchomp_name_grab, LW(5), LW(10))
                    USER_FUNC(spm::evt_mario::evt_rpg_calc_damage_to_enemy, LW(5), 104, LW(11))
...
EVT_BEGIN(checkWinOrContinue)
    ...
    IF_NOT_FLAG(LW(0), 0x8000)
        RETURN()
    END_IF()
    USER_FUNC(spm::evt_mario::evt_rpg_enemy_take_damage, 1, LW(0))
    IF_NOT_FLAG(LW(0), 0x8000)
        RETURN()
    END_IF()
    USER_FUNC(spm::evt_mario::evt_rpg_enemy_take_damage, 2, LW(0))
    IF_NOT_FLAG(LW(0), 0x8000)
        RETURN()
    END_IF()
    INLINE_EVT()
