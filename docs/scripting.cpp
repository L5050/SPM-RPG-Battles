...
USER_FUNC(spm::evt_rpg::evt_rpg_change_menu_flag)
...
IF_SMALL(GSW(0), 324)
    ...
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_133"), PTR(spm::an2_08::evt_an2_08_draw_face), 0)
ELSE()
    USER_FUNC(spm::evt_map::evt_mapobj_get_position, PTR("kuti_1"), LW(0), LW(1), LW(2))
    USER_FUNC(spm::evt_msg::evt_msg_toge, 2, LW(0), LW(1), LW(2))
    USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_133_2_129"), PTR(spm::an2_08::evt_an2_08_draw_face), 0)
END_IF()
USER_FUNC(spm::evt_cam::evt_cam3d_evt_zoom_in, 1, 3475, 1070, 184, 3475, 1070, -16, 500, 11)
WAIT_MSEC(500)
USER_FUNC(spm::evt_map::evt_mapobj_get_position, PTR("kuti_1"), LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_toge, 2, LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_133_1"), PTR(spm::an2_08::evt_an2_08_draw_face), 0)
...
USER_FUNC(spm::evt_map::evt_mapobj_get_position, PTR("kuti_1"), LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_toge, 2, LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_133_2"), PTR(spm::an2_08::evt_an2_08_draw_face), 0)
...
USER_FUNC(spm::evt_map::evt_mapobj_get_position, PTR("kuti_1"), LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_toge, 2, LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_133_2_128"), PTR(spm::an2_08::evt_an2_08_draw_face), 0)
...
USER_FUNC(spm::evt_map::evt_mapobj_get_position, PTR("kuti_1"), LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_toge, 2, LW(0), LW(1), LW(2))
USER_FUNC(spm::evt_msg::evt_msg_print, 0, PTR("stg7_2_134"), PTR(spm::an2_08::evt_an2_08_draw_face), 0)
