...
namespace mod {
  ...
  EVT_BEGIN(koopa_striker_attack_strong)
    SET(LW(0), 0)
    IF_EQUAL(LW(0), 0)
      SET(LW(0), 0)
      SET(LW(4), 0)
          ...
          USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_E_KOURASHOOTER_SET1"))
          USER_FUNC(evt_npc_wait_anim_end, LW(15), 1)
          SET(LW(14), LW(15))
          USER_FUNC(evt_npc_entry_autoname, PTR("e_k_shooter_k"), 0, LW(15))
          ...
          USER_FUNC(evt_npc_set_anim, LW(14), 11, 1)
          WAIT_MSEC(750)
  ...
  EVT_BEGIN(koopa_striker_attack_weak)
    SET(LW(0), 0)
    IF_EQUAL(LW(0), 0)
      SET(LW(0), 0)
      SET(LW(4), 0)
          ...
          USER_FUNC(evt_npc_set_position, LW(15), LW(5), LW(6), LW(7))
          USER_FUNC(evt_npc_flag8_onoff, LW(15), 1, 201326596)
          USER_FUNC(evt_npc_set_anim, LW(14), 9, 1)
          WAIT_MSEC(350)
          USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_E_KICK_KOURA1"))
          INLINE_EVT()
            USER_FUNC(evt_npc_wait_anim_end, LW(14), 1)
  ...
  EVT_BEGIN(koopa_striker_attack)
    USER_FUNC(spm::evt_sub::evt_sub_random, 100, LW(0))
    SWITCH(LW(0))
      CASE_SMALL_EQUAL(50)
        RUN_CHILD_EVT(koopa_striker_attack_strong)
      CASE_ETC()
        RUN_CHILD_EVT(koopa_striker_attack_weak)
    END_SWITCH()
    RETURN()
  RETURN()
  EVT_END()
