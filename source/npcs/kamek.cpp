  ...
  EVT_BEGIN(kamek_attack)
    ...
    CASE_EQUAL(2)
      ...
      IF_EQUAL(GSWF(1803), 1)
          USER_FUNC(spm::an2_08::evt_rpg_status_remove, 1, 1, 0x3)
          USER_FUNC(spm::evt_npc::evt_npc_set_animpose_disp_callback, PTR("npc2"), PTR(spm::mi4::mi4MimiHolographicEffect), 0)
          USER_FUNC(spm::an2_08::evt_rpg_enemy_take_damage, 1, -2, 0, EVT_NULLPTR)
      END_IF()
      USER_FUNC(spm::an2_08::evt_rpg_enemy_death_check, 0, LW(1))
      IF_NOT_FLAG(LW(1), 0x3)
        IF_NOT_FLAG(LW(1), 0x8000)
