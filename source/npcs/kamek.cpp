...
namespace mod {
  ...
  EVT_BEGIN(check_for_the_bois)
    ...
    IF_EQUAL(LW(1), 3)
      ...
      USER_FUNC(spm::evt_npc::evt_npc_set_position, PTR("npc1"), LW(0), 5, LW(2))
      ...
      USER_FUNC(evt_npc_flag8_onoff, PTR("npc1"), 1, 8)
      USER_FUNC(evt_npc_flag8_onoff, PTR("npc1"), 0, 134217728)
      ...
      USER_FUNC(spm::evt_npc::evt_npc_set_position, PTR("npc3"), LW(0), 5, LW(2))
      ...
      USER_FUNC(evt_npc_flag8_onoff, PTR("npc3"), 1, 8)
      USER_FUNC(evt_npc_flag8_onoff, PTR("npc3"), 0, 134217728)
