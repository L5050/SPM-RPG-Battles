...
namespace mod {
  ...
  EVT_BEGIN(met_onhit)
    ...
    IF_EQUAL(LW(0), 0)
      ...
      IF_EQUAL(LW(11), 1)
        ...
        USER_FUNC(evt_npc_set_property, LW(15), 14, (s32)animsMet2)
  ...
  EVT_BEGIN(met_attack)
    ...
    IF_EQUAL(LW(0), 0)
      SET(LW(4), 0)
          ...
          DIV(LW(14), 2)
          ADD(LW(5), LW(14))
          USER_FUNC(evt_npc_walk_to, LW(15), LW(5), LW(7), FLOAT(0.0), FLOAT(200.0), 0, 0, 0)
  ...
  void met_main()
  {
    npcTribes[25].maxHp = 3;
    npcTribes[25].attackStrength = 2;
  }
