...
"<o>\n";
  ...
  EVT_BEGIN(chunks_on_spawn)
    ...
    USER_FUNC(spm::evt_mobj::evt_mobj_set_scale, PTR("mobj2"), FLOAT(4.0), FLOAT(2.5), FLOAT(4.0))
...
EVT_BEGIN(chunks_attack)
    ...
    SWITCH(LW(0))
      CASE_EQUAL(0)
          ...
          */
          ...
          //DIV(LW(14), 2)
          ADD(LW(0), LW(14))
          USER_FUNC(evt_npc_walk_to, LW(15), LW(0), LW(2), FLOAT(0.0), FLOAT(250.0), 0, 0, 0)
  ...
  EVT_BEGIN(chunks_throw)
    ...
    BROTHER_EVT_ID(LW(14))
        ...
        INLINE_EVT()
          WAIT_FRM(2)
          USER_FUNC(spm::evt_npc::evt_npc_set_unitwork, LW(15), 6, 4)
        END_INLINE()
