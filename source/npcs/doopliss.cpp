...
NPCTribeAnimDef animsDoopliss[] = {
  ...
  NPCTribeAnimDef animsPeach_HAMPTER[] = {
    {0, "S_1B"},
    {1, "W_1"},
    {2, "R_1"},
    {3, "T_1"},
...
EVT_DECLARE_USER_FUNC(fix_doopliss_being_annoying, 1)
  ...
  USER_FUNC(evt_npc_set_position, PTR("peach"), LW(0), LW(1), LW(2))
  INLINE_EVT()
    WAIT_FRM(1)
    USER_FUNC(evt_npc_set_anim, PTR("peach"), 2, 1)
    USER_FUNC(evt_npc_walk_to, PTR("peach"), 40, 0, 0, FLOAT(80.0), 0, 0, 0)
    WAIT_FRM(1)
    USER_FUNC(evt_npc_set_anim, PTR("peach"), 0, 1)
    SET(LW(0), 0)
    DO(0)
      ADD(LW(0), 12)
      USER_FUNC(evt_npc_rotate, PTR("peach"), 0, LW(0), 0)
      WAIT_FRM(1)
  ...
  END_INLINE()
  USER_FUNC(spm::evt_mario::evt_mario_walk_to, FLOAT(80.0), FLOAT(0.0), 1000)
  WAIT_FRM(1)
  ...
  USER_FUNC(evt_npc_delete, PTR("kansyu"))
  USER_FUNC(fix_doopliss_being_annoying, PTR("kansyu"))
  ...
  WAIT_FRM(1)
  USER_FUNC(evt_npc_set_anim, PTR("peach"), 8, 1)
  ...
  USER_FUNC(spm::evt_npc::evt_npc_set_position, PTR("peach"), 0, -100, 0)
  RETURN()
  EVT_END()

  EVT_BEGIN(kansyu_fwd)
  ...
  EVT_BEGIN(hampter_room_init)
    ...
    USER_FUNC(evt_npc_set_property, PTR("peach"), 14, (s32)animsPeach_HAMPTER)
  ...
  EVT_BEGIN(doopliss_mario_attack)
    ...
    USER_FUNC(evt_npc_walk_to, LW(15), LW(0), 0, LW(2), FLOAT(180.0), 0, 0, 0)
    WAIT_FRM(1)
    ...
    USER_FUNC(evt_npc_set_anim, LW(15), 2, 1)
    USER_FUNC(evt_npc_walk_to, LW(15), LW(0), LW(1), LW(2), FLOAT(180.0), 0, 0, 0)
  ...
  EVT_BEGIN(doopliss_attack)
    ...
    SWITCH(LW(0))
      CASE_EQUAL(0)
        ...
        ADDF(LW(0), FLOAT(15.0))
        ADDF(LW(1), LW(8))
        SUB(LW(1), FLOAT(25.0))
        USER_FUNC(evt_npc_jump_to, LW(15), LW(0), LW(1), LW(2), 50, FLOAT(500.0))
        USER_FUNC(spm::an2_08::evt_rpg_char_get, LW(3))
        USER_FUNC(check_guards, 3, 13, LW(11))
        IF_EQUAL(LW(11), 2)
          USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_F_COUNTER_REBOUND1"))
          USER_FUNC(spm::evt_mario::evt_mario_set_pose, PTR("J_1B"), 0)
          USER_FUNC(evt_npc_set_anim, LW(15), 4, 1)
        ...
        USER_FUNC(spm::evt_mario::evt_mario_get_pos, LW(0), LW(1), LW(2))
        ADD(LW(0), 35)
        USER_FUNC(evt_npc_jump_to, LW(15), LW(0), 0, LW(2), 50, FLOAT(500.0))
      CASE_EQUAL(1)
        USER_FUNC(evt_npc_set_anim, LW(15), 6, 1)
        ...
        USER_FUNC(spm::evt_npc::evt_npc_glide_to, LW(15), LW(5), LW(6), LW(7), 0, FLOAT(40.0), 0, 11, 0, 0)
        SUB(LW(6), 50)
        ADD(LW(5), -150)
        SET(LW(12), 150)
        INLINE_EVT()
        ...
        USER_FUNC(spm::evt_mario::evt_mario_get_pos, LW(0), LW(1), LW(2))
        WAIT_FRM(10)
        USER_FUNC(spm::evt_npc::evt_npc_glide_to, LW(15), LW(0), LW(6), LW(7), 0, FLOAT(700.0), 0, 0, 0, 0)
        //USER_FUNC(evt_npc_jump_to, LW(15), LW(0), LW(6), LW(7), 50, FLOAT(500.0))
        USER_FUNC(spm::an2_08::evt_rpg_char_get, LW(3))
        USER_FUNC(check_guards, 3, 13, LW(11))
        IF_EQUAL(LW(11), 2)
          USER_FUNC(spm::evt_snd::evt_snd_sfxon, PTR("SFX_F_COUNTER_REBOUND1"))
  ...
  USER_FUNC(spm::evt_npc::evt_npc_get_unitwork, LW(15), 1, LW(1))
  USER_FUNC(spm::evt_npc::evt_npc_get_unitwork, LW(15), 2, LW(2))
  USER_FUNC(evt_npc_walk_to, LW(15), LW(0), LW(1), LW(2), FLOAT(140.0), 0, 0, 0)
  USER_FUNC(evt_npc_set_anim, LW(15), 0, 1)
  USER_FUNC(ac_success_reset)
  LBL(5)
  CHK_EVT(LW(4), LW(0))
  ...
  EVT_BEGIN(doopliss_death)
    ...
    SUB(LW(13), 100)
    USER_FUNC(spm::evt_cam::evt_cam3d_evt_zoom_in, 0, LW(5), EVT_NULLPTR, LW(13), LW(5), EVT_NULLPTR, 200, 1000, 11)
    USER_FUNC(spm::evt_msg::evt_msg_print, 1, PTR(doopliss_death_feign_1), 0, LW(15))
    USER_FUNC(spm::evt_msg::evt_msg_print, 1, PTR(doopliss_death_feign_2), 0, LW(15))
    INLINE_EVT()
      SUB(LW(13), 10)
      ADD(LW(5), 50)
      USER_FUNC(spm::evt_cam::evt_cam3d_evt_zoom_in, 0, LW(5), EVT_NULLPTR, LW(13), LW(5), EVT_NULLPTR, 200, 1000, 11)
    ...
    BROTHER_EVT_ID(LW(5))
      ...
      DO(0)
        ...
        USER_FUNC(evt_npc_set_color, LW(10), 255, LW(0), 0, 255)
        WAIT_FRM(1)
        IF_EQUAL(LW(1), 0)
        DO_BREAK()
        END_IF()
      ...
      DO(0)
        USER_FUNC(spm::evt_sub::evt_sub_intpl_msec_get_value)
        USER_FUNC(evt_npc_set_color, LW(10), LW(0), 255, 0, 255)
        WAIT_FRM(1)
        IF_EQUAL(LW(1), 0)
        DO_BREAK()
        END_IF()
      ...
      DO(0)
        USER_FUNC(spm::evt_sub::evt_sub_intpl_msec_get_value)
        USER_FUNC(evt_npc_set_color, LW(10), LW(0), 255, LW(0), 255)
        WAIT_FRM(1)
        IF_EQUAL(LW(1), 0)
        DO_BREAK()
        END_IF()
    ...
    USER_FUNC(evt_npc_get_position, LW(15), LW(5), LW(6), LW(7))
    USER_FUNC(evt_npc_delete, LW(15))
    USER_FUNC(fix_doopliss_being_annoying, LW(15))
    USER_FUNC(spm::evt_npc::evt_npc_entry, LW(15), PTR("p_mario"), 0)
    USER_FUNC(spm::evt_npc::evt_npc_set_position, LW(15), LW(5), LW(6), LW(7))
    USER_FUNC(evt_npc_set_disp_callback, LW(15), PTR(marioLuigiNpcDispCb))
    USER_FUNC(evt_npc_set_property, LW(15), 14, (s32)animsDooplissMario)
    USER_FUNC(evt_npc_set_anim, LW(15), 0, 1)
    USER_FUNC(evt_npc_set_color, LW(15), 252, 3, 53, 255)
    WAIT_FRM(1)
    USER_FUNC(evt_npc_set_unitwork, LW(15), 0, LW(5))
    USER_FUNC(evt_npc_set_unitwork, LW(15), 1, LW(6))
    USER_FUNC(evt_npc_set_unitwork, LW(15), 2, LW(7))
  ...
  void doopliss_main()
  {
    ...
    evtpatch::hookEvtReplace(mi3_03_md->initScript, 113, (spm::evtmgr::EvtScriptCode*)insertNop);
  }
