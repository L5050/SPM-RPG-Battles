...
EVT_BEGIN(end_of_turn_stylish)
    ...
    IF_EQUAL(LW(11), 1)
        ...
        USER_FUNC(spm::evt_eff::evt_eff, 0, PTR("nice"), 0, 150, 0, 0, FLOAT(1.0), 0, 0, 0, 0, 0, 0, 0)  //@TODO Figure out good hardcoded 2D offsets
        SET(LW(5), UW(4))
        INLINE_EVT()
            SET(LW(11), 0)
        ...
        IF_EQUAL(LW(11), 1)
            ...
            USER_FUNC(spm::evt_eff::evt_eff, 0, PTR("nice"), 1, -250, 0, 0, FLOAT(1.0), 0, 0, 0, 0, 0, 0, 0)
            SET(LW(5), UW(4))
            INLINE_EVT()
                SET(LW(11), 0)
                SETF(LW(10), FLOAT(0.0))
